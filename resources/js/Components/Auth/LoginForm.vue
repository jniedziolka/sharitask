    ...
    <div class="container max-w-xl bg-purple-200 flex flex-col items-center py-8 rounded">
        <form class="w-3/4" @submit.prevent="submit">
            <div class="flex flex-col mb-6">
                ...
                <input id="email" v-model="form.email" type="text" autocomplete="usernmae" class="border-purple-300 text-gray-700 rounded shadow focus:ring-2 focus:ring-purple-500 focus:border-transparent"/>
            </div>
            <div class="flex flex-col mb-6">
                <label for="password" class="mb-2 text-purple-500">Password</label>
                <input id="password" v-model="form.password" type="password" autocomplete="current-password" class="border-purple-300 rounded shadow focus:ring-2 focus:ring-purple-500 focus:border-transparent"/>
            </div>
